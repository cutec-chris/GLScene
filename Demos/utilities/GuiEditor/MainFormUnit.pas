...
uses
  ...
  //GLS
  GLScene, GLLCLViewer, GLGui, GLObjects, GLHUDObjects, GLWindows, GLBitmapFont,
  GLWindowsFont, GLTexture, GLCrossPlatform, GLMaterial,
  GLCoordinates, GLBaseClasses, FGuiSkinEditorLCL;
...
begin
    SetCurrentDirUTF8(ParamStrUTF8(0));
   with GLMaterialLibrary1.Materials[0].Material.Texture.Image do
      LoadFromFile('..'+DirectorySeparator+'..'+DirectorySeparator+'media'+DirectorySeparator+'DefaultSkin.bmp');
end;
