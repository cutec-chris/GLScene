...
{: GLVectorGeometry<p>
   ...
   all Intel processors after Pentium should be immune to this.<p>
	...
	<b>History : </b><font size=-1><ul>
      ...
      <li>16/04/07 - DaStr - Removed TMatrix[3/4][w/e] types (declared in GLVectorTypes.pas)
      ...
      <li>13/01/07 - DaStr - Added RayCastBoxIntersect and IntersectTriangleBox (Thanx to dikoe Kenguru)
                             ...
                             some other types moved to GLVectorTypes unit
      ...
      <li>26/10/03 - EG - Renamed from "Geometry.pas" to "GLVectorGeometry.pas"
      ...
      <li>04/07/01 - EG - Now uses GLVectorTypes
...
uses GLCrossPlatform, GLVectorTypes;
...
begin
  if (Round(DistortionDegree) <> DistortionDegree) and (Delta < 0) then
    Result := (Stop - Start) * GLVectorGeometry.Power(Delta, integer(Round(DistortionDegree))) + Start
  else
...
begin
  ...
  Tran[ttRotateY]:=GLVectorGeometry.ArcSin(-row0[Z]);
