...
function TGLTextureExItem.QueryInterface(constref iid: tguid; out obj
  ): longint; cdecl;
begin
...
function TGLTextureExItem._AddRef: longint; cdecl;
begin
  Result := -1; //ignore
end;
...
function TGLTextureExItem._Release: longint; cdecl;
begin
  Result := -1; //ignore
end;
